    ...
    <div className="relative text-white min-h-screen">
      ...
      <div className="sticky top-0 z-50 backdrop-blur-md bg-black/30 border-b border-white/10 shadow-md">
        <div className="w-full px-8 py-4 flex items-center justify-between">
          ...
          <div className="space-x-8 text-sm font-medium tracking-wide text-gray-300">
            {[
              { label: "Home", to: "/home" },
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-[90vh] px-6 text-center">
        ...
        <div className="relative z-10 max-w-3xl mx-auto w-full">
          ...
          <Link to="/aichat">
            <button className="px-8 py-3 rounded-xl font-semibold text-sm bg-gradient-to-r from-blue-600 via-cyan-600 to-emerald-600 hover:opacity-90 transition shadow-lg shadow-cyan-500/20">
              Start AI Chat
            </button>
          </Link>
      ...
      {/* Stats Bar */}
      <div className="relative z-10 px-8 mb-20">
        <div className="backdrop-blur-md bg-white/5 border border-white/10 rounded-2xl px-8 py-6 max-w-3xl mx-auto grid grid-cols-3 divide-x divide-white/10 text-center">
          {[
            ...
            <div key={i} className="px-6">
              <div className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-emerald-400">{stat.value}</div>
      ...
      {/* Features Section */}
      <div className="relative z-10 px-8 max-w-5xl mx-auto mb-24">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
          {[
            ...
            <Link to={feature.link} key={i}>
              <div className="backdrop-blur-md bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-cyan-500/40 hover:bg-white/8 transition-all duration-300 h-full cursor-pointer group">
                <div className="text-3xl mb-4">{feature.icon}</div>
                <div className="text-white font-semibold text-sm mb-2 group-hover:text-cyan-400 transition">{feature.title}</div>
      ...
      {/* How it works */}
      <div className="relative z-10 px-8 max-w-4xl mx-auto mb-24">
        ...
        <div className="grid grid-cols-3 gap-6">
          {[
            ...
            <div key={i} className="backdrop-blur-md bg-white/5 border border-white/10 rounded-2xl p-7 text-center hover:border-white/20 transition">
              <div className="text-5xl font-black text-transparent bg-clip-text bg-gradient-to-b from-cyan-400/30 to-transparent mb-5 leading-none">{item.step}</div>
