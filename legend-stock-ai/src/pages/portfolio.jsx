  ...
  const loadPortfolioIntelligence = async () => {
    ...
    try {
      ...
      const res = await fetch(
        "https://stock-backend-gsyw.onrender.com/portfolio/intelligence",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json"
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white">
      <div className="max-w-7xl mx-auto px-6 py-10">
        ...
        <div className="bg-gray-900 rounded-2xl border border-cyan-500/20 p-6 mb-6">
          ...
          <div className="flex justify-between items-center mb-4">
            ...
            <span
              ...
              ${
                portfolioIntel.portfolio_health >= 80
                  ? "bg-green-500/20 text-green-400"
                  : portfolioIntel.portfolio_health >= 60
                  ? "bg-yellow-500/20 text-yellow-400"
                  : "bg-red-500/20 text-red-400"
              }`}
            >
              Health {portfolioIntel.portfolio_health}%
            </span>

          </div>

          <p className="text-gray-300 mb-4">
            {portfolioIntel.portfolio_summary}
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="bg-black/30 p-4 rounded-xl">
              ...
              <div className="font-bold">
                {portfolioIntel.top_opportunity?.symbol}
              </div>

              <div className="text-xs text-gray-400 mt-2">
                {portfolioIntel.top_opportunity?.reason}
              </div>
            ...
            <div className="bg-black/30 p-4 rounded-xl">
              ...
              <div className="font-bold">
                {portfolioIntel.top_risk?.symbol}
              </div>

              <div className="text-xs text-gray-400 mt-2">
                {portfolioIntel.top_risk?.reason}
              </div>
